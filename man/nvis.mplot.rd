...
\item{png}{name of png file in string format. If "off", doesnt create file. Default: "nvis_mplot.png"}
\item{width}{png file pixel dimension, default is 11400}
\item{height}{png file pixel dimension, default is 3000}
...
nvis.mplot(dataset = "small",pxlist,pylist,color="FORCES", png="off")
}
